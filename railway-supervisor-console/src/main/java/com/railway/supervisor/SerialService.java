 ...
 * </p>
 * <ul>
 *   <li>Open {@code COM5} at 9600 8N1 (demo default for Windows fare-repeater dongles).</li>
...
public final class SerialService {
    ...
    /** Supervisor demo default (Windows); adjust if deploying on POSIX named devices. */
    public static final String DEFAULT_PORT_NAME = "COM5";
